...
*app.extraction.input_preprocessing*
...
The `input_preprocessing` module contains functions to filter and copy videos from the original dataset. There are five setup variables:
...
*app.extraction.video_extraction*

To extract landmarks from the videos and save them as video objects, use the module `video_extraction`. There are four setup variables:
